...
The images must follow the limit size:

- Portrailt: width >= 2084 and height >= 2796
- Landscape: width >= 2796 and width >= 2084

Otherwise the splash you want could be broken
...
- Copy the `splash-screens` folder into the folder where you put the `index.html` file

![folder](./assets//images/folder.png)

- Place those asset linking in the top of the `index.html` file
